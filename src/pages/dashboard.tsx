                ...
                <Dashboard>
                    <main class="flex-1 space-y-4 py-5">
                        <div class="relative flex items-center justify-between">
                            <div>
                                <h2 class="text-5xl" safe>Welcome, {session.user.name}</h2>
                                <p class="text-xl">Here is the overvies of your account:</p>
                            </div>
                            <div class="pr-10 text-right text-5xl" safe>{organization.name}</div>
